...
FormatoSalida::FormatoSalida(ContextoFormato& context,
...
void FormatoSalida::writeFrame(const char* data, SwsContext* ctx ) {
...
void FormatoSalida::codecContextInit(AVCodec* codec){
